...
export default function FollowersListUser({ route }) {
    ...
    useEffect(() => {
        if (userData.userId) {
          ...
          axios
            .post('https://rui2666.pythonanywhere.com/get_followers_list', requestBody)
            .then((response) => {
    ...
    const styles = StyleSheet.create({
      container: {
          flex: 1,
          backgroundColor: '#F3F2EF', // Soft off-white background
      },
      itemContainer: {
          flexDirection: 'row',
          alignItems: 'center',
